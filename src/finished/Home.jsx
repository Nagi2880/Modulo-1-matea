        ...
        <div id="Home-container" className=''>
            <div className='d-none d-sm-none d-md-block'>   
                ...
                <body id="Body-container" className='d-flex flex-column align-items-center'>
                    <img id="background" className='col col-sm-12 col-md-12 col-xl-12' alt="background" src="./background.png" />
                    <h2 id="Body-subtitle" className='col col-sm-12 col-md-12 col-lg-10 col-xl-8'>PONGAMOS MUSICA, JUNTOS</h2>
